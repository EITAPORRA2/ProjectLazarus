...
local Window = Lib:MakeWindow({Name = "Universe Hub", HidePremium = false, SaveConfig = true, ConfigFolder = "Universe Hub"})
...
Gun:AddLabel("Gostosas Peladas Xxx")
